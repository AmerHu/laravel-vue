  ...
  <nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="mobile-only-brand pull-left">
      <div class="nav-header pull-left">
        <div class="logo-wrap">
          <a href="index.html">
            <img class="brand-img" width="25" src="img/logo.png" alt="brand" />
            <span class="brand-text">EPension</span>
          </a>
        </div>
      </div>
      <a
      ...
      <ul class="nav navbar-right top-nav pull-right">
            ...
            <li class="product-nicescroll-bar row">
              <ul class="pa-20">
                ...
                <li class="col-md-6 col-xs-12 preview-carousel">
                  <a href="javascript:void(0);">
                    <div class="pull-left">
                      <span class="right-nav-text">latest reports</span>
                    </div>
                    <div class="clearfix"></div>
                  </a>
                  <hr class="light-grey-hr ma-0" />
        ...
        <li class="dropdown alert-drp">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            ...
            <span class="top-nav-icon-badge">1</span>
          </a>
          <ul
                ...
                <div class="sl-item">
                  <a href="javascript:void(0)">
                    ...
                    <div class="sl-content">
                      ...
                      >New contribution submitted</span>
                      <span class="inline-block font-11 pull-right notifications-time">2pm</span>
                      <div class="clearfix"></div>
                      <p
                        class="truncate"
                      >The Company ABC Trading has submitted the contribution for the current month...</p>
                    </div>
                  </a>
                </div>
                <hr class="light-grey-hr ma-0" />
